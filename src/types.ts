...
} from "@idapt/api-contracts/v1/contracts/credentials";
import type {
  AgentResponse,
  AgentRunResponse,
  ...
  RetryResult as RetryResultContract,
...
export type RetryResult = RetryResultContract;
...
export type CredentialVersion = CredentialVersionResponse;
