...
export type AutomationActionType = "agent-run";
...
export type LLMModelArchitectureType = "dense" | "moe" | "hybrid";
...
export interface LLMModelLocalInferenceVariant {
  tag: string;
...
export interface LLMModelLocalInference {
  runtimes: {
    ollama: {
      base_id: string;
...
export interface AiGatewayRoutePreviewCapabilities {
  tool_use?: boolean;
  reasoning?: boolean;
  vision?: boolean;
  audio_input?: boolean;
...
export interface AiGatewayRoutePreviewOption {
  model_id: string;
  connector_id: string;
...
export interface AiGatewayRoutePreviewSkippedOption
  extends AiGatewayRoutePreviewOption {
  reason: "window_too_small" | "not_in_sticky_route";
}

export interface AiGatewayRoutePreview {
  model_id: string;
...
export interface VideoModelSearchItem {
  id: string;
  display_name: string;
  provider: string;
  provider_slug: string;
...
export interface VideoModelSearchResult {
