...
export const COMMAND_BINDINGS: Record<string, CommandBinding> = {
  ...
  "computer tunnel-close": {
    "command": "computer tunnel-close",
    "method": "DELETE",
  ...
  "computer tunnel-make-public": {
    "command": "computer tunnel-make-public",
    "method": "POST",
    "path": "/computers/:id/tunnels/public",
    "pathParams": [
      "id"
    ],
    "argLocation": "body",
  ...
  "computer tunnel-open": {
    "command": "computer tunnel-open",
    "method": "POST",
    "path": "/computers/:id/tunnels",
    "pathParams": [
      "id"
  ...
  "computer tunnel-revoke-public": {
    "command": "computer tunnel-revoke-public",
    "method": "DELETE",
    "path": "/computers/:id/tunnels/public",
    "pathParams": [
      "id"
  ...
  "integration call": {
    ...
    "method": "POST",
    "path": "/integrations/connections/:id/tools/:tool/call",
    "pathParams": [
      "id",
      "tool"
    ],
  ...
  "integration connect": {
    "command": "integration connect",
    "method": "POST",
    "path": "/integrations/connections/:id/connect",
    "pathParams": [
      "id"
    ],
    "argLocation": "body",
  ...
  "integration describe": {
    ...
    "method": "GET",
    "path": "/integrations/connections/:id/tools/:tool",
    "pathParams": [
      "id",
      "tool"
    ],
  ...
  "integration discover": {
    "command": "integration discover",
    "method": "GET",
    "path": "/integrations/discover",
    "pathParams": [],
    "argLocation": "query",
    "responseKind": "single",
    "async": false
  ...
  "integration prompt": {
    "command": "integration prompt",
    "method": "POST",
    "path": "/integrations/connections/:id/prompts/:name",
    "pathParams": [
      "id",
      "name"
    ],
  ...
  "integration prompts": {
    "command": "integration prompts",
    "method": "GET",
    "path": "/integrations/connections/:id/prompts",
    "pathParams": [
      "id"
    ],
    "argLocation": "query",
  ...
  "integration resource": {
    ...
    "method": "GET",
    "path": "/integrations/connections/:id/resources/read",
    "pathParams": [
      "id"
    ],
    "argLocation": "query",
  ...
  "integration resources": {
    "command": "integration resources",
    "method": "GET",
    "path": "/integrations/connections/:id/resources",
    "pathParams": [
      "id"
    ],
    "argLocation": "query",
  ...
  "integration search": {
    ...
    "method": "GET",
    "path": "/integrations/connections/:id/tools/search",
    "pathParams": [
      "id"
    ],
    "argLocation": "query",
  ...
  "integration tools": {
    "command": "integration tools",
    "method": "GET",
    "path": "/integrations/connections/:id/tools",
    "pathParams": [
      "id"
    ],
    "argLocation": "query",
