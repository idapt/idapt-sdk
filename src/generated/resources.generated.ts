...
export class ComputersApiBase {
  ...
  async fsDownload(id: string, path: V1Args<"computer download">["path"], opts: ExecuteCommandOptions = {}): Promise<Blob> {
    return executeCommand<Blob>(COMMAND_BINDINGS["computer download"], { id, path }, this.ctx, opts);
  }
  ...
  async updatePort(id: string, input: PatchPortInput, opts: CallOptions = {}): Promise<V1Result<"computer set-ports">> {
    return executeCommand<V1Result<"computer set-ports">>(COMMAND_BINDINGS["computer set-ports"], { id, ...input }, this.ctx, opts);
  }
  ...
  async listUserEnvVars(id: string, username: string, opts: CallOptions = {}): Promise<V1Result<"computer user-env">["data"]> {
    const res = await executeCommand<V1Result<"computer user-env">>(COMMAND_BINDINGS["computer user-env"], { id, username }, this.ctx, opts);
    return res.data;
  }

  async createUserEnvVar(id: string, username: string, input: CreateUserEnvVarInput, opts: CallOptions = {}): Promise<V1Result<"computer set-user-env">> {
    return executeCommand<V1Result<"computer set-user-env">>(COMMAND_BINDINGS["computer set-user-env"], { id, username, ...input }, this.ctx, opts);
  }

  async deleteUserEnvVar(id: string, username: string, name: string, opts: CallOptions = {}): Promise<DeletedResponse> {
    return executeCommand<DeletedResponse>(COMMAND_BINDINGS["computer delete-user-env"], { id, username, name }, this.ctx, opts);
  }

  async setupUserEnv(id: string, username: string, opts: CallOptions = {}): Promise<V1Result<"computer user-env-setup-apply">> {
    return executeCommand<V1Result<"computer user-env-setup-apply">>(COMMAND_BINDINGS["computer user-env-setup-apply"], { id, username }, this.ctx, opts);
  }

  async checkUserEnvSetup(id: string, username: string, opts: CallOptions = {}): Promise<V1Result<"computer user-env-setup">> {
    return executeCommand<V1Result<"computer user-env-setup">>(COMMAND_BINDINGS["computer user-env-setup"], { id, username }, this.ctx, opts);
  }

  async syncUserEnv(id: string, username: string, opts: CallOptions = {}): Promise<V1Result<"computer user-env-sync-repair">> {
    return executeCommand<V1Result<"computer user-env-sync-repair">>(COMMAND_BINDINGS["computer user-env-sync-repair"], { id, username }, this.ctx, opts);
  }

  async checkUserEnvSync(id: string, username: string, opts: CallOptions = {}): Promise<V1Result<"computer user-env-sync">> {
    return executeCommand<V1Result<"computer user-env-sync">>(COMMAND_BINDINGS["computer user-env-sync"], { id, username }, this.ctx, opts);
  }
...
export type PatchPortInput = V1Args<"computer set-ports">;
...
export type CreateUserEnvVarInput = V1Args<"computer set-user-env">;
...
export class SecretsApiBase {
  constructor(protected readonly ctx: HttpContext) {}

  async get(id: string, opts: CallOptions = {}): Promise<V1Result<"secret get">> {
    return executeCommand<V1Result<"secret get">>(COMMAND_BINDINGS["secret get"], { id }, this.ctx, opts);
  }

  async create(input: CreateSecretInput, opts: CallOptions = {}): Promise<V1Result<"secret create">> {
    return executeCommand<V1Result<"secret create">>(COMMAND_BINDINGS["secret create"], { ...input }, this.ctx, opts);
  }

  async update(id: string, input: UpdateSecretInput = {}, opts: CallOptions = {}): Promise<V1Result<"secret update">> {
    return executeCommand<V1Result<"secret update">>(COMMAND_BINDINGS["secret update"], { id, ...input }, this.ctx, opts);
  }

  async delete(id: string, opts: CallOptions = {}): Promise<DeletedResponse> {
    return executeCommand<DeletedResponse>(COMMAND_BINDINGS["secret delete"], { id }, this.ctx, opts);
  }

  async reveal(id: string, opts: CallOptions = {}): Promise<V1Result<"secret reveal">> {
    return executeCommand<V1Result<"secret reveal">>(COMMAND_BINDINGS["secret reveal"], { id }, this.ctx, opts);
  }
}

export type CreateSecretInput = V1Args<"secret create">;
export type UpdateSecretInput = V1Args<"secret update">;
