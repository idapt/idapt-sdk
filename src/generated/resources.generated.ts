...
export class ChatsApi {
  ...
  async setGoal(id: string, input: V1Args<"chat set-goal">, opts: CallOptions = {}): Promise<V1Result<"chat set-goal">> {
    return executeCommand<V1Result<"chat set-goal">>(COMMAND_BINDINGS["chat set-goal"], { id, ...input }, this.ctx, opts);
  }

  async getGoal(id: string, opts: CallOptions = {}): Promise<V1Result<"chat goal">> {
    return executeCommand<V1Result<"chat goal">>(COMMAND_BINDINGS["chat goal"], { id }, this.ctx, opts);
  }

  async endGoal(id: string, opts: CallOptions = {}): Promise<V1Result<"chat end-goal">> {
    return executeCommand<V1Result<"chat end-goal">>(COMMAND_BINDINGS["chat end-goal"], { id }, this.ctx, opts);
  }

  async resumeGoal(id: string, input: V1Args<"chat resume-goal"> = {}, opts: CallOptions = {}): Promise<V1Result<"chat resume-goal">> {
    return executeCommand<V1Result<"chat resume-goal">>(COMMAND_BINDINGS["chat resume-goal"], { id, ...input }, this.ctx, opts);
  }
  ...
  async sendMessage(id: string, input: SendMessageInput, opts: CallOptions = {}): Promise<V1Result<"chat send">> {
  ...
  async retryRun(id: string, runId: string, input: RetryRunInput = {}, opts: CallOptions = {}): Promise<V1Result<"chat retry">> {
    return executeCommand<V1Result<"chat retry">>(COMMAND_BINDINGS["chat retry"], { id, run_id: runId, ...input }, this.ctx, opts);
  }
}
...
export type RetryRunInput = V1Args<"chat retry">;
...
export class ModelsApi {
  ...
  async get(id: string, opts: CallOptions = {}): Promise<V1Result<"models get">> {
    return executeCommand<V1Result<"models get">>(COMMAND_BINDINGS["models get"], { id }, this.ctx, opts);
  }
...
export class MeApi {
  ...
  async limits(opts: CallOptions = {}): Promise<V1Result<"me limits">> {
    return executeCommand<V1Result<"me limits">>(COMMAND_BINDINGS["me limits"], {}, this.ctx, opts);
  }
}
...
export class SubscriptionApi {
  ...
  async get(id: string, opts: CallOptions = {}): Promise<V1Result<"team subscription">> {
    return executeCommand<V1Result<"team subscription">>(COMMAND_BINDINGS["team subscription"], { id }, this.ctx, opts);
  }

  async usage(id: string, opts: CallOptions = {}): Promise<V1Result<"team usage">> {
    return executeCommand<V1Result<"team usage">>(COMMAND_BINDINGS["team usage"], { id }, this.ctx, opts);
  }

  async storage(id: string, opts: CallOptions = {}): Promise<V1Result<"team storage">> {
    return executeCommand<V1Result<"team storage">>(COMMAND_BINDINGS["team storage"], { id }, this.ctx, opts);
  }
}
...
export class ComputersApiBase {
  ...
  async manage(id: string, input: ManageComputerInput, opts: CallOptions = {}): Promise<V1Result<"computer manage">> {
    return executeCommand<V1Result<"computer manage">>(COMMAND_BINDINGS["computer manage"], { id, ...input }, this.ctx, opts);
  }
  ...
  async exec(id: string, input: ExecCommandInput, opts: CallOptions = {}): Promise<V1Result<"computer exec">> {
  ...
  async allow(id: string, input: V1Args<"computer allow">, opts: CallOptions = {}): Promise<V1Result<"computer allow">["exposure"]> {
    const res = await executeCommand<V1Result<"computer allow">>(COMMAND_BINDINGS["computer allow"], { id, ...input }, this.ctx, opts);
    return res["exposure"];
  }

  async updateAllowance(id: string, workspaceId: string, capabilities: V1Args<"computer update-allowance">["capabilities"], opts: CallOptions = {}): Promise<V1Result<"computer update-allowance">["exposure"]> {
    const res = await executeCommand<V1Result<"computer update-allowance">>(COMMAND_BINDINGS["computer update-allowance"], { id, workspace_id: workspaceId, capabilities }, this.ctx, opts);
    return res["exposure"];
  }

  async revoke(id: string, workspaceId: string, opts: CallOptions = {}): Promise<V1Result<"computer revoke">> {
    return executeCommand<V1Result<"computer revoke">>(COMMAND_BINDINGS["computer revoke"], { id, workspace_id: workspaceId }, this.ctx, opts);
  }
...
export type ManageComputerInput = V1Args<"computer manage">;
...
export class ContainersApi {
  ...
  async create(input: V1Args<"container create">, opts: CallOptions = {}): Promise<V1Result<"container create">> {
  ...
  async composeUp(input: V1Args<"container compose-up">, opts: CallOptions = {}): Promise<V1Result<"container compose-up">> {
    return executeCommand<V1Result<"container compose-up">>(COMMAND_BINDINGS["container compose-up"], { ...input }, this.ctx, opts);
  }

  async run(input: V1Args<"container run">, opts: CallOptions = {}): Promise<V1Result<"container run">> {
  ...
  async up(id: string, opts: CallOptions = {}): Promise<V1Result<"container up">> {
  ...
  async rebuild(id: string, input: V1Args<"container rebuild"> = {}, opts: CallOptions = {}): Promise<V1Result<"container rebuild">> {
  ...
  async exec(id: string, input: V1Args<"container exec">, opts: CallOptions = {}): Promise<V1Result<"container exec">> {
  ...
  async portOpen(id: string, input: V1Args<"container port-open">, opts: CallOptions = {}): Promise<V1Result<"container port-open">> {
    return executeCommand<V1Result<"container port-open">>(COMMAND_BINDINGS["container port-open"], { id, ...input }, this.ctx, opts);
  }

  async portClose(id: string, input: V1Args<"container port-close">, opts: CallOptions = {}): Promise<V1Result<"container port-close">> {
    return executeCommand<V1Result<"container port-close">>(COMMAND_BINDINGS["container port-close"], { id, ...input }, this.ctx, opts);
  }

  async portMakePublic(id: string, input: V1Args<"container port-make-public">, opts: CallOptions = {}): Promise<V1Result<"container port-make-public">> {
    return executeCommand<V1Result<"container port-make-public">>(COMMAND_BINDINGS["container port-make-public"], { id, ...input }, this.ctx, opts);
  }

  async portRevokePublic(id: string, input: V1Args<"container port-revoke-public">, opts: CallOptions = {}): Promise<V1Result<"container port-revoke-public">> {
    return executeCommand<V1Result<"container port-revoke-public">>(COMMAND_BINDINGS["container port-revoke-public"], { id, ...input }, this.ctx, opts);
  }

  async backup(id: string, input: V1Args<"container backup"> = {}, opts: CallOptions = {}): Promise<V1Result<"container backup">> {
    return executeCommand<V1Result<"container backup">>(COMMAND_BINDINGS["container backup"], { id, ...input }, this.ctx, opts);
  }

  async restore(id: string, input: V1Args<"container restore"> = {}, opts: CallOptions = {}): Promise<V1Result<"container restore">> {
  ...
  async migrate(id: string, input: V1Args<"container migrate">, opts: CallOptions = {}): Promise<V1Result<"container migrate">> {
...
export class CredentialsApi {
  ...
  async connect(input: V1Args<"credential connect"> = {}, opts: CallOptions = {}): Promise<V1Result<"credential connect">> {
    return executeCommand<V1Result<"credential connect">>(COMMAND_BINDINGS["credential connect"], { ...input }, this.ctx, opts);
  }

  async allow(id: string, input: V1Args<"credential allow">, opts: CallOptions = {}): Promise<V1Result<"credential allow">> {
    return executeCommand<V1Result<"credential allow">>(COMMAND_BINDINGS["credential allow"], { id, ...input }, this.ctx, opts);
  }
}
...
export class HttpApi {
  ...
  async request(input: V1Args<"http request">, opts: CallOptions = {}): Promise<V1Result<"http request">> {
    return executeCommand<V1Result<"http request">>(COMMAND_BINDINGS["http request"], { ...input }, this.ctx, opts);
  }
}
...
export class McpApi {
  ...
  async info(input: V1Args<"mcp info"> = {}, opts: CallOptions = {}): Promise<V1Result<"mcp info">> {
    return executeCommand<V1Result<"mcp info">>(COMMAND_BINDINGS["mcp info"], { ...input }, this.ctx, opts);
  }

  async tools(input: V1Args<"mcp tools"> = {}, opts: CallOptions = {}): Promise<V1Result<"mcp tools">["data"]> {
    const res = await executeCommand<V1Result<"mcp tools">>(COMMAND_BINDINGS["mcp tools"], { ...input }, this.ctx, opts);
    return res.data;
  }

  async call(input: V1Args<"mcp call">, opts: CallOptions = {}): Promise<V1Result<"mcp call">> {
    return executeCommand<V1Result<"mcp call">>(COMMAND_BINDINGS["mcp call"], { ...input }, this.ctx, opts);
  }

  async prompts(input: V1Args<"mcp prompts"> = {}, opts: CallOptions = {}): Promise<V1Result<"mcp prompts">> {
    return executeCommand<V1Result<"mcp prompts">>(COMMAND_BINDINGS["mcp prompts"], { ...input }, this.ctx, opts);
  }

  async prompt(input: V1Args<"mcp prompt">, opts: CallOptions = {}): Promise<V1Result<"mcp prompt">> {
    return executeCommand<V1Result<"mcp prompt">>(COMMAND_BINDINGS["mcp prompt"], { ...input }, this.ctx, opts);
  }

  async resources(input: V1Args<"mcp resources"> = {}, opts: CallOptions = {}): Promise<V1Result<"mcp resources">> {
    return executeCommand<V1Result<"mcp resources">>(COMMAND_BINDINGS["mcp resources"], { ...input }, this.ctx, opts);
  }

  async resource(input: V1Args<"mcp resource">, opts: CallOptions = {}): Promise<V1Result<"mcp resource">> {
    return executeCommand<V1Result<"mcp resource">>(COMMAND_BINDINGS["mcp resource"], { ...input }, this.ctx, opts);
  }
}
...
export class ServicesApi {
  ...
  async search(query: V1Args<"service search"> = {}, opts: CallOptions = {}): Promise<V1Result<"service search">["data"]> {
    const res = await executeCommand<V1Result<"service search">>(COMMAND_BINDINGS["service search"], { ...query }, this.ctx, opts);
    return res.data;
  }

  async lookup(slug: string, query: V1Args<"service lookup"> = {}, opts: CallOptions = {}): Promise<V1Result<"service lookup">> {
    return executeCommand<V1Result<"service lookup">>(COMMAND_BINDINGS["service lookup"], { slug, ...query }, this.ctx, opts);
  }
}
...
export class KnowledgeNotesApi {
  constructor(protected readonly ctx: HttpContext) {}

  async list(opts: CallOptions = {}): Promise<V1Result<"knowledge list">["data"]> {
    const res = await executeCommand<V1Result<"knowledge list">>(COMMAND_BINDINGS["knowledge list"], {}, this.ctx, opts);
    return res.data;
  }

  async read(title: V1Args<"knowledge read">["title"], query: Omit<V1Args<"knowledge read">, "title"> = {}, opts: CallOptions = {}): Promise<V1Result<"knowledge read">> {
    return executeCommand<V1Result<"knowledge read">>(COMMAND_BINDINGS["knowledge read"], { title, ...query }, this.ctx, opts);
  }

  async write(input: NotesWriteInput, opts: CallOptions = {}): Promise<V1Result<"knowledge write">> {
    return executeCommand<V1Result<"knowledge write">>(COMMAND_BINDINGS["knowledge write"], { ...input }, this.ctx, opts);
  }

  async delete(title: V1Args<"knowledge delete">["title"], input: Omit<V1Args<"knowledge delete">, "title"> = {}, opts: CallOptions = {}): Promise<DeletedResponse> {
    return executeCommand<DeletedResponse>(COMMAND_BINDINGS["knowledge delete"], { title, ...input }, this.ctx, opts);
  }

  async rename(title: V1Args<"knowledge note-rename">["title"], newTitle: V1Args<"knowledge note-rename">["new_title"], input: Omit<V1Args<"knowledge note-rename">, "title" | "new_title"> = {}, opts: CallOptions = {}): Promise<V1Result<"knowledge note-rename">> {
    return executeCommand<V1Result<"knowledge note-rename">>(COMMAND_BINDINGS["knowledge note-rename"], { title, new_title: newTitle, ...input }, this.ctx, opts);
  }

  async move(title: V1Args<"knowledge note-move">["title"], input: Omit<V1Args<"knowledge note-move">, "title"> = {}, opts: CallOptions = {}): Promise<V1Result<"knowledge note-move">> {
    return executeCommand<V1Result<"knowledge note-move">>(COMMAND_BINDINGS["knowledge note-move"], { title, ...input }, this.ctx, opts);
  }
}

export type NotesWriteInput = V1Args<"knowledge write">;

export class KnowledgeFoldersApi {
  constructor(protected readonly ctx: HttpContext) {}

  async list(opts: CallOptions = {}): Promise<V1Result<"knowledge folder-list">["data"]> {
    const res = await executeCommand<V1Result<"knowledge folder-list">>(COMMAND_BINDINGS["knowledge folder-list"], {}, this.ctx, opts);
    return res.data;
  }

  async create(input: V1Args<"knowledge folder-create">, opts: CallOptions = {}): Promise<V1Result<"knowledge folder-create">> {
    return executeCommand<V1Result<"knowledge folder-create">>(COMMAND_BINDINGS["knowledge folder-create"], { ...input }, this.ctx, opts);
  }

  async rename(folderId: string, input: V1Args<"knowledge folder-rename">, opts: CallOptions = {}): Promise<V1Result<"knowledge folder-rename">> {
    return executeCommand<V1Result<"knowledge folder-rename">>(COMMAND_BINDINGS["knowledge folder-rename"], { folderId, ...input }, this.ctx, opts);
  }

  async move(folderId: string, input: V1Args<"knowledge folder-move"> = {}, opts: CallOptions = {}): Promise<V1Result<"knowledge folder-move">> {
    return executeCommand<V1Result<"knowledge folder-move">>(COMMAND_BINDINGS["knowledge folder-move"], { folderId, ...input }, this.ctx, opts);
  }

  async delete(folderId: string, opts: CallOptions = {}): Promise<DeletedResponse> {
    return executeCommand<DeletedResponse>(COMMAND_BINDINGS["knowledge folder-delete"], { folderId }, this.ctx, opts);
  }
}

export class KnowledgeIndexApi {
  constructor(protected readonly ctx: HttpContext) {}

  async read(opts: CallOptions = {}): Promise<V1Result<"knowledge index-read">> {
    return executeCommand<V1Result<"knowledge index-read">>(COMMAND_BINDINGS["knowledge index-read"], {}, this.ctx, opts);
  }

  async write(content: V1Args<"knowledge index-write">["content"], input: Omit<V1Args<"knowledge index-write">, "content"> = {}, opts: CallOptions = {}): Promise<V1Result<"knowledge index-write">> {
    return executeCommand<V1Result<"knowledge index-write">>(COMMAND_BINDINGS["knowledge index-write"], { content, ...input }, this.ctx, opts);
  }
}

export class KnowledgeApiBase {
  constructor(protected readonly ctx: HttpContext) {}

  async search(q: V1Args<"knowledge search">["q"], query: Omit<V1Args<"knowledge search">, "q"> = {}, opts: CallOptions = {}): Promise<V1Result<"knowledge search">["data"]> {
    const res = await executeCommand<V1Result<"knowledge search">>(COMMAND_BINDINGS["knowledge search"], { q, ...query }, this.ctx, opts);
    return res.data;
  }

  async graph(opts: CallOptions = {}): Promise<V1Result<"knowledge graph">> {
    return executeCommand<V1Result<"knowledge graph">>(COMMAND_BINDINGS["knowledge graph"], {}, this.ctx, opts);
  }

  async links(noteId: string, opts: CallOptions = {}): Promise<V1Result<"knowledge links">> {
    return executeCommand<V1Result<"knowledge links">>(COMMAND_BINDINGS["knowledge links"], { noteId }, this.ctx, opts);
  }

  async tree(opts: CallOptions = {}): Promise<V1Result<"knowledge tree">> {
    return executeCommand<V1Result<"knowledge tree">>(COMMAND_BINDINGS["knowledge tree"], {}, this.ctx, opts);
  }

  async tagList(opts: CallOptions = {}): Promise<V1Result<"knowledge tag-list">["data"]> {
    const res = await executeCommand<V1Result<"knowledge tag-list">>(COMMAND_BINDINGS["knowledge tag-list"], {}, this.ctx, opts);
    return res.data;
  }

  async tagRename(input: V1Args<"knowledge tag-rename">, opts: CallOptions = {}): Promise<V1Result<"knowledge tag-rename">> {
    return executeCommand<V1Result<"knowledge tag-rename">>(COMMAND_BINDINGS["knowledge tag-rename"], { ...input }, this.ctx, opts);
  }

  async import(input: V1Args<"knowledge import">, opts: CallOptions = {}): Promise<V1Result<"knowledge import">> {
    return executeCommand<V1Result<"knowledge import">>(COMMAND_BINDINGS["knowledge import"], { ...input }, this.ctx, opts);
  }

  async trashList(query: V1Args<"knowledge trash-list"> = {}, opts: CallOptions = {}): Promise<V1Result<"knowledge trash-list">["data"]> {
    const res = await executeCommand<V1Result<"knowledge trash-list">>(COMMAND_BINDINGS["knowledge trash-list"], { ...query }, this.ctx, opts);
    return res.data;
  }

  async restore(input: V1Args<"knowledge restore">, opts: CallOptions = {}): Promise<DeletedResponse> {
    return executeCommand<DeletedResponse>(COMMAND_BINDINGS["knowledge restore"], { ...input }, this.ctx, opts);
  }

  async purge(input: V1Args<"knowledge purge">, opts: CallOptions = {}): Promise<DeletedResponse> {
    return executeCommand<DeletedResponse>(COMMAND_BINDINGS["knowledge purge"], { ...input }, this.ctx, opts);
  }

  async trashEmpty(input: V1Args<"knowledge trash-empty"> = {}, opts: CallOptions = {}): Promise<V1Result<"knowledge trash-empty">> {
    return executeCommand<V1Result<"knowledge trash-empty">>(COMMAND_BINDINGS["knowledge trash-empty"], { ...input }, this.ctx, opts);
  }
}
